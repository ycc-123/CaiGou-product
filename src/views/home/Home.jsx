      ...
      <HomeStyle>
        ...
        <div className='footer'>
          ...
          <ul>
            ...
            <li onClick={()=>{this.props.history.push('/TransferOrder')}} style={{marginLeft:".2rem"}}><img src="https://dev.huodiesoft.com/addons/lexiangpingou/data/share/tiaobodan.png" alt=""/></li>
