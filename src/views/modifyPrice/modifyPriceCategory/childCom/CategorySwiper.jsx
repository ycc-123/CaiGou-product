...
import { getPriceModifyDetail } from 'network/Api'
                  ...
                  <div className='tiao' key={k}>
                    ...
                    <ul className='wen-zi'>
                      ...
                      <li className='wen-zi-c'>
                        <div >商品编码：{v.code}</div>
                        <p style={{ color: "#DD1717" }} style={{ display: v.memberPrice === "1" ? "none" : "block" }}>
                          <img style={{ width: ".32rem", height: ".32rem", marginBottom: ".05rem" }} src={"https://res.lexiangpingou.cn/images/applet/99969memberPrice.png"} alt="" />
