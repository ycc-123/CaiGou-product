...
class Category extends Component {
  ...
  click = (e) => {
    ...
    this.setState({
      ...
      alert(Number(this.state.dataName.toString()) === 111 ? (e===1?"是否确认保存盘点单":this.state.wulin) : (e===1?"存在下列实际数量为0的商品是否保存":this.state.weilin), Number(this.state.dataName.toString()) === 111 ? "" : this.state.dataName.join(","), [
